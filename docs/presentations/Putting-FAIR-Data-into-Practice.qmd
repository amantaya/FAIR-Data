---
title: "Putting FAIR Data into Practice"
event: "Dr. Short & Dr. Martin Lab Meeting"
...
- B.S. in Fish and Wildlife Biology, minor in GIS
- Worked as a Research Specialist (Rangelands) for University of Arizona from 2018-2024
- Hired as Data Coordinator for the SDSU Climate Smart Project in July 2024
:::

##

![OSF Research Lifecycle](../attachments/research_lifecycle.original.png)

::: notes

This is a diagram of the research lifecycle from the Open Science Framework (OSF). The research lifecycle is a conceptual model that describes the stages of a research project, from planning to publication. I included this diagram to highlight some of the digital tools and where they fit into the research lifecycle. For example, the DMPTool is used during the planning stage to create a data management plan, while Dryad is used during the publication stage to archive data. I will be discussing these tools and others in more detail later in the presentation.
:::
...
::: incremental
- FAIR is a set of principles, *not an implementation*
- It's up to you (and your advisor) to make these decisions
- There are many options, no one choice is best
:::

::: notes
The important thing about the FAIR principles is that they don't tell you how to make your data FAIR. Instead, think of the FAIR principles as guidelines, not rules. It's up to you (and your advisor) to make these decisions. There are many options, and no one choice is best. In this presentation, I will present some options for making your data FAIR, but it will be up to you (and your advisor) to decide which options are best for your project.
:::
...
2. Others Can Reuse and Build Upon Your Work (Which is Good for Your Career)
...
![Screenshot of Accessible Dataset on Dryad's Website](../attachments/example-accessible-dryad-dataset.jpg)
...
![Screenshot of Accessible Data Through Dryad's API](../attachments/example-accessible-dryad-api.jpg)
...
![Screenshot of Accessible Data Through Zenodo's API](../attachments/example-accessible-zenodo-api.jpg)
...
Microsoft Excel, while a proprietary file format, is widely used and supported and can be a good choice for archiving your data. However, be aware that Excel has some limitations, such as the number of rows and columns that it can handle. If you are working with a large dataset, you may want to consider archiving your data in a different format, such as CSV.  I generally recommend CSV files over Excel files in almost all situations.

Now that's not to say you can't use STATA and SPSS file formats during your analysis. STATA and SPSS files have some advatanges over CSV files. However, I recommend that you convert your data to a non-proprietary format before archiving it, for example, by converting your data from a STATA file to a CSV file. This will make your data more interoperable with others.
...
::: notes
Perhaps the most important aspect of FAIR data is making your data reusable by others (including your future self). If your data is not reusable by others, then what’s the point of making it findable, accessible, and interoperable?

There are two main ways that you can make your data reusable: by providing rich metadata and following metadata standards.
...
::: incremental
- [Data Management Plan](https://datamgmtinedresearch.com/dmp)
- [Data Sources Catalog](https://datamgmtinedresearch.com/dmp#dmp-catalog)
- [Roles and Responsibilities](https://datamgmtinedresearch.com/roles)
- [Research Protocol](https://datamgmtinedresearch.com/document#document-protocol)
- [Standard Operating Proceedures](https://datamgmtinedresearch.com/document#document-sop)
:::

## Dataset Level Metadata

::: incremental
- [README](https://datamgmtinedresearch.com/document#document-read)
- [Changelog](https://datamgmtinedresearch.com/document#document-change)
- [Data Cleaning Plan](https://datamgmtinedresearch.com/document#document-plan)
:::

## Variable Level Metadata

::: incremental
- [Data Dictionary](https://datamgmtinedresearch.com/document#document-dictionary)
- [Codebook](https://datamgmtinedresearch.com/document#document-codebook)
:::
...
Be warned, metadata standards have a steep learning curve. I would recommend that you first identify which metadata standard is relevant to your field, and then find a digital tool that can help you create metadata in that standard. For example, I use the ezEML tool to create EML metadata for my data. I have included links to these tools in the Additional Resources section at the end of this presentation.
:::
...
- Choose a repository to archive your data
- Check if the repository requires specific metadata standards (e.g., EML)
- Check if the funder has specific requirements for data archiving (e.g., AgData Commons)
- Archive your data in a widely used and non-proprietary file format (e.g., CSV)
:::

## My Advice for Grad Students

::: incremental
- Write a Data Management Plan (DMP) - Think Through the Steps to Make Your Data FAIR
- Discuss the DMP with your Advisor Sooner Rather Than Later
...
I also recommend that you discuss your data management plan with your advisor sooner rather than later. Your advisor may also have specific requirements specified by the funder, such as where the data must be archived, so be sure to check with them before you start or check the funder's website for more information.
